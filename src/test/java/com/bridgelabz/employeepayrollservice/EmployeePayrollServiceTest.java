...
public class EmployeePayrollServiceTest 
{
	...
	@Test
	public void givenEmployeePayrollInDB_ShouldRetrieveCountEmployeeSalaryWithGenderMap()
	{
		EmployeePayrollService employeePayrollService = new EmployeePayrollService();

		Map<String, Double> countSalaryMap = employeePayrollService.getCountSalaryBasedOnGender( IOService.DB_IO);

		Assert.assertEquals(countSalaryMap.get("F"),(Double)1.0);
		Assert.assertEquals(countSalaryMap.get("M"),(Double)2.0);
	}
