...
ALTER TABLE employee_payroll add department varchar(10) not null after address;
...
SELECT SUM(basic_pay),gender  
FROM payroll   
JOIN employee  
ON payroll.id=employee.id
GROUP BY gender;

SELECT AVG(basic_pay),gender  
FROM payroll   
JOIN employee  
ON payroll.id=employee.id
GROUP BY gender;

SELECT COUNT(basic_pay),gender  
FROM payroll   
JOIN employee  
ON payroll.id=employee.id
GROUP BY gender;

SELECT MIN(basic_pay),gender  
FROM payroll   
JOIN employee  
ON payroll.id=employee.id
GROUP BY gender;

SELECT MAX(basic_pay),gender  
FROM payroll   
JOIN employee  
ON payroll.id=employee.id
GROUP BY gender;
